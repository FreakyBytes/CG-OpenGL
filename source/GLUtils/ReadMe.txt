========================================================================
    STATISCHE BIBLIOTHEK: Utils-Projektübersicht
========================================================================

Dieses Utils-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Utils-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Utils.pch und eine 
